...
<context>
    ...
    <message>
        ...
        <source>Transistor Output Characteristics</source>
        <comment>flowPara3372</comment>
        <translation>Caractéristiques de sortie d&apos;un transistor</translation>
    </message>
    <message>
        <location filename="en/Brochure-eyes17/Back.svg"/>
        <source>Output characteristics of an NPN transistor are being obtained in this experiment. The collector voltage is swept using the programmable voltage output, PV1, and a series 1K resistor is used to limit the current as well as to act as a shunt to measure the voltage drop across the transistor&apos;s C &amp; E. Base current is set via another source, PV2, and a 100k resistor. Collector and base voltages are monitored using analog inputs A1 &amp; A2. </source>
        <comment>flowPara3388</comment>
        <translation>Des caractéristiques de sortie d&apos;un transistor NPN sont obtenues dans cette expérience. La tension du collecteur est balayée à l&apos;aide de la sortie de tension programmable, PV1, et une résistance en série de 1 kΩ  est utilisée pour limiter le courant ainsi que comme shunt pour mesurer le courant CE. Le courant de base est réglé à partir d&apos;une autre source, PV2, à l&apos;aide d&apos;une résistance de 100 kΩ . Les tensions de collecteur et de base sont enregistrées à l&apos;aide des entrées A1 et A2. </translation>
    </message>
    <message>
        <location filename="en/Brochure-eyes17/Back.svg"/>
        <source>Transient  Response of LCR Circuits</source>
        <comment>flowPara3402</comment>
    ...
    <message>
        <location filename="en/Brochure-eyes17/Back.svg"/>
        <source>The examples shown above are mostly electrical and electronics experiments but  experiments on Mechanics, Sound, Heat etc. are also documented in the user manual. The programs are written in Python, due to its simple syntax and availability of modules for scientific computation and graphics. </source>
        <comment>flowPara3420</comment>
    ...
    <message>
        <location filename="en/Brochure-eyes17/Back.svg"/>
        <source> The website also  contains a lot documentation on ExpEYES including videos and a user manual. It  has some  Python resources to support teaching physics and mathematics. Information on MicroHOPE, a micro-controller development kit and KuttyPy, a simple device to do  control/monitoring using python, are also available.</source>
        <comment>flowPara3440</comment>
